...
export { validateEmail } from './utils/email-regex';
export { validateNumber } from './utils/number-regex';
export { validatePassword } from './utils/password-regex';
export { validateName } from './utils/name-regex';
